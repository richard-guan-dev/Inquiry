...
public class AvailabilityHistoryActivity extends BaseActivity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		history2home = (Button) findViewById(R.id.go_home3);
		history2home.setOnClickListener(new OnClickListener() {
			
			public void onClick(View v) {
			AvailabilityHistoryActivity.this.finish();
			}
		});
	...
	class HistoryListItemOnClickListener implements OnItemClickListener {
		...
		public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,
			...
			Intent i = new Intent(AvailabilityHistoryActivity.this, AvailabilityDetailActivity.class);
			//选中中的信息传递方式。。.
